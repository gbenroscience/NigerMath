...
import math.graph.GraphType;
import math.graph.GridExpressionParser;
 ...
 */
public class FunctionTracer1 extends javax.swing.JFrame implements Runnable {
     ...
     */
    public FunctionTracer1(String function) {
        ...
        paper.getGrid().setLocationOfOrigin(new Point(paper.getWidth() / 2, paper.getHeight() / 2));
        try {
    ...
    public void loadValuesToControllerFromProgram() {
        ...
        System.out.println("----"+paper.getGrid().getGridSize());
        gridSizeSpinner.setValue(paper.getGrid().getGridSize());
    ...
    public void loadFunctionsOntoTables() {
        ...
        ArrayList<String> simpleFunctions = gep.getPlottable();
        for (int i = 0; i < status.size(); i++) {

            if (status.get(i).isVerticePlot()) {
                ...
                verticesTable.setValueAt(i + 1, i, 0);
                verticesTable.setValueAt(simpleFunctions.get(i).substring(0, simpleFunctions.get(i).indexOf("]") + 1), i, 1);
                verticesTable.setValueAt(simpleFunctions.get(i).substring(simpleFunctions.get(i).indexOf("]") + 1), i, 2);

            } else if (status.get(i).isFunctionPlot()) {
                ...
                functionTable.setValueAt(i + 1, i, 0);
                functionTable.setValueAt(simpleFunctions.get(i), i, 1);
            }//end else if
            else {
    ...
    public void setPaper(GraphPaper paper) {
        this.paper = paper;
        chooser.setFontObject(paper.getGrid().getFont());
    }

    public GraphPaper getPaper() {
        return paper;
    }
    ...
    private void initComponents() {
        ...
        paper = new math.graph.gui.GraphPaper();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setName("Form"); // NOI18N

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(nigermath.NigerMathApp.class).getContext().getResourceMap(FunctionTracer1.class);
        ...
        paper.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED), javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED)), javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED), javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED))), javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED), javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED)), javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED), javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED)))));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(paper, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(panel, javax.swing.GroupLayout.DEFAULT_SIZE, 733, Short.MAX_VALUE)
        );
...
//Set Values In Table As Relevant When User Presses Ok Or Cancel To Close Dialog
    ...
    private void saveGraphButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveGraphButtonActionPerformed
        ...
        ImageUtilities.createSwingObjectImage(paper);
    ...
    private void setGridSize() {
        paper.getGrid().setGridSize((Integer) gridSizeSpinner.getValue());
    }

    private void setTextFontSize() {
        try {
            Font font = paper.getGrid().getFont();
            double gridSize = paper.getGrid().getGridSize();
    ...
    public static void main(String args[]) {
        ...
        FunctionTracer1 props = new FunctionTracer1("y=@(x)cos(x)");
    ...
    private math.graph.gui.GraphPaper paper;
