...
/**
 * Objects of this class take a compound plot instruction,
 * scan it into all smaller plot instructions,
 * and then analyze each instruction to determine its type.
 * They store a record of each smaller plot instruction
 * in an ArrayList object(plottable) and a record of the type of each
 * of those instructions in another ArrayList object(graphType)
...
public class GridExpressionParser{
    ...
    private ArrayList<String>plottable=new ArrayList<String>();
    private ArrayList<GraphType> graphType = new ArrayList<GraphType>();
    /**
...
/**
 *
 * @param gep Another GridExpressionParser object.
 * Appends the function definitions in the other GridExpressionParser
 * object to the functions in this one.
 */
