...
public static void main(String args[]){
    VariableGenerator varGen= new VariableGenerator(6);
    Variable variant=varGen.generateVariable();
    JOptionPane.showMessageDialog(null,"Randomly Generated Name:  "+variant.getName()+"\n" +
           "Randomly Generated Value:  "+variant.getValue(),"Automatically Generating...",JOptionPane.INFORMATION_MESSAGE);
}
